...
export class Animation {
    ...
    /**
     * callback on after delay finish
     */
    onIdle
    ...
    /**
     * @param {string} name animation name as id
     ...
     * @returns {Animation}
     */
    windToTimeLoop(milliseconds, isResponsive = true) {
        const {duration, delay} = this

        return this.windToTime(milliseconds % (duration + delay), isResponsive)
    }

    /**
     * Pushes animation forward to given milliseconds
    ...
    update(elapsedTime) {
        ...
        const milliseconds = (duration + delay) * progress + elapsedTime
        ...
        if (isLoopMode) {
            this.windToTimeLoop(milliseconds)
        } else {
            this.windToTime(milliseconds)
            this.isPlaying = this.progress < 1
        }
